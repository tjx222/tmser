...
public class RsaUtil {
    ...
    public static String rsaSign(String content, String privateKey, String charset,
        ...
        if (RsaConstants.SIGN_TYPE_RSA.equals(signType)) {

            return rsaSign(content, privateKey, charset);
        } else if (RsaConstants.SIGN_TYPE_RSA2.equals(signType)) {
    ...
    public static String rsa256Sign(String content, String privateKey,
        ...
        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(RsaConstants.SIGN_TYPE_RSA,
                    new ByteArrayInputStream(privateKey.getBytes()));

            java.security.Signature signature = java.security.Signature
                    .getInstance(RsaConstants.SIGN_SHA256RSA_ALGORITHMS);
    ...
    public static String rsaSign(String content, String privateKey,
        ...
        try {
            ...
            java.security.Signature signature = java.security.Signature
                    .getInstance(RsaConstants.SIGN_ALGORITHMS);
    ...
    public static String encryptAndSign(String bizContent, String alipayPublicKey,
        ...
        if (StringUtils.isEmpty(charset)) {
            charset = RsaConstants.CHARSET_GBK;
        }
    ...
    public static String rsaEncrypt(String content, String publicKey,
                                    String charset) throws ApiException {
        try {
            PublicKey pubKey = getPublicKeyFromX509(RsaConstants.SIGN_TYPE_RSA,
                    new ByteArrayInputStream(publicKey.getBytes()));
            Cipher cipher = Cipher.getInstance(RsaConstants.SIGN_TYPE_RSA);
