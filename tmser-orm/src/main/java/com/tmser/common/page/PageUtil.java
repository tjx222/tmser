...
import com.tmser.common.bo.PageAble;
...
public class PageUtil
{
	 ...
	 * @return
	 */
	public static <T>  PageList<T> createPageList(List<T> list,PageAble pageAware){
		return new PageList<T>(list,pageAware.getPage());
	}
