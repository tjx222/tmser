...
public class SampleWebApplication {
    ...
    private static Logger log = LoggerFactory.getLogger(SampleWebApplication.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            log.info("===================");
            log.info("===================");
            final ConfigurableApplicationContext app = SpringApplication.run(SampleWebApplication.class, args);
            stopwatch.stop();
