...
public class ServiceUtils {
    ...
    public static Pageable buildLatestPageable(int top, @NonNull String sortProperty) {
        ...
        PageImpl<Object> of = PageImpl.of(0, top);
        of.setSort(Sort.by(Sort.Direction.DESC, sortProperty));
        return of;
    }
    ...
    public static <T, S> Page<T> buildEmptyPageImpl(@NonNull Page<S> page) {
        ...
        return PageImpl.of(page.getCurrent(), page.getTotal());
    }
