package com.tmser.blog.model.enums;
 ...
 * @author johnniang
 */
public interface ValueEnum<T extends Serializable> extends IEnum<T> {
     ...
     */
    static <V extends Serializable, E extends Enum<E> & ValueEnum<V>> E valueToEnum(Class<E> enumType, V value) {
