...
import com.tmser.blog.model.enums.ValueEnum;
...
public interface OptionProvideService {
     ...
     */
    Page<OptionSimpleDTO> pageDtosBy(@NonNull Page pageable, OptionQuery optionQuery);
     ...
     */
    @NonNull
    default <V extends Serializable, E extends Enum<E> & ValueEnum<V>> Optional<E> getValueEnumByProperty(
     ...
     */
    @Nullable
    default <V extends Serializable, E extends Enum<E> & ValueEnum<V>> E getValueEnumByPropertyOrDefault(
            @NonNull PropertyEnum property,
