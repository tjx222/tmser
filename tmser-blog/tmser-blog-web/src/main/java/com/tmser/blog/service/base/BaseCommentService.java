...
public interface BaseCommentService<COMMENT extends BaseComment>
     ...
     */
    @NonNull
    Page<COMMENT> pageBy(@NonNull CommentQuery commentQuery, @NonNull Page pageable);
     ...
     */
    @NonNull
    Page<BaseCommentVO> pageVosAllBy(@NonNull Integer postId, @NonNull Page pageable);
     ...
     */
    @NonNull
    Page<BaseCommentVO> pageVosBy(@NonNull Integer postId, @NonNull Page pageable);
     ...
     */
    @NonNull
    Page<BaseCommentVO> pageVosBy(@NonNull Integer postId, @NonNull Page pageable, Sort sort);
     ...
     */
    @NonNull
    Page<BaseCommentVO> pageVosBy(@NonNull List<COMMENT> comments, @NonNull Page pageable, Sort sort);
    ...
    Page<CommentWithHasChildrenVO> pageTopCommentsBy(@NonNull Integer targetId,
                                                     @NonNull CommentStatus status, @NonNull Page pageable);
