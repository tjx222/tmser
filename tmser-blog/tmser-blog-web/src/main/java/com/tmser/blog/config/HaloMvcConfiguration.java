...
import com.tmser.blog.core.freemarker.inheritance.ThemeExtendsDirective;
import com.tmser.blog.factory.StringToEnumConverterFactory;
import com.tmser.blog.security.resolver.AuthenticationArgumentResolver;
...
import static com.tmser.blog.model.support.HaloConst.FILE_SEPARATOR;
...
public class HaloMvcConfiguration implements WebMvcConfigurer {
    ...
    public HaloMvcConfiguration(HaloProperties haloProperties) {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        String workDir = FILE_PROTOCOL + HaloUtils.ensureSuffix(haloProperties.getWorkDir(), FILE_SEPARATOR);
        ...
        String uploadUrlPattern =
                HaloUtils.ensureBoth(haloProperties.getUploadUrlPrefix(), HaloUtils.URL_SEPARATOR) + "**";
