 ...
 */
@Entity
@Table(name = XkItem.TABLE_NAME)
public class XkItem extends QueryObject {
  ...
  public static final String TABLE_NAME = "tal_xk_item_lx";
  ...
  public boolean equals(final Object other) {
    if (!(other instanceof XkItem))
      return false;
    XkItem castOther = (XkItem) other;
